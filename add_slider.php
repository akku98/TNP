...
<div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a>Slider Management</a>
                    </li>
                    <li class="active">
                        <strong>Add A New Slider</strong>
                    </li>
                </ol><br>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1"><b> Adding a New Slider </b></a></li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <?php echo form_open_multipart('SliderFormSubmit');
                                        ?>
                                        <fieldset class="form-horizontal">
                                            
                                            <div class="form-group"><label class="col-sm-2 control-label">Slider Name *</label>
             									<div class="col-sm-7"><input type="text" name="name" class="form-control" required autofocus="" placeholder="Enter Here A Slider Name" tabindex="1"></div>
                                            </div>
											
                                            <div class="form-group"><label class="col-sm-2 control-label">Slider Description *</label>
                                                <div class="col-sm-7"><input type="text" name="description" class="form-control" required autofocus="" placeholder="Enter Here A Slider Description" tabindex="2"></div>
                                            </div>
											
                                            
                                            <div class="form-group"><label class="col-sm-2 control-label"> Pick A Slider Image *</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group"><div class="col-sm-3 control-label"></div>
                                                <div class="col-sm-4"><button class="form-control btn btn-success btn-rounded" tabindex="6"><strong>Upload</strong></button> </div>
                                            </div>
                                        </fieldset>
                                        <?php form_close();?>
                                    </div>
	...
	<?php
        ...
        <?php }
		elseif($item=='yes'){ ?>
			<script>swal("Successfully Added In Database...!!!", "Browse To Add More Slider !", "success");</script>
		<?php
			}
		}
        ?>
