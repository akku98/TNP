						...
						<div class="row">
							<div class="col-md-8" style="height:200%;">
								...
								<div class="tr-content">
                                    <div class="resp-container"  style="height:3900px;">
 
                                        <iframe class="resp-iframe" style="border-radius:10px;" src="<?=base_url('CpfView')?>" gesture="media"  allow="encrypted-media" allowfullscreen></iframe>
