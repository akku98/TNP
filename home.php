...
<head>
      ...
      <!--//meta tags ends here-->
      <!--booststrap-->
      <link href="<?=base_url()?>theme/user/toy/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
      <!--//booststrap end-->
      <!-- font-awesome icons -->
      <link href="<?=base_url()?>theme/user/toy/css/fontawesome-all.min.css" rel="stylesheet" type="text/css" media="all">
      <!-- //font-awesome icons -->
      <!-- For Clients slider -->
      <link rel="stylesheet" href="<?=base_url()?>theme/user/toy/css/flexslider.css" type="text/css" media="all" />
      <!--flexs slider-->
      <link href="<?=base_url()?>theme/user/toy/css/JiSlider.html" rel="stylesheet">
      <!--Shoping cart-->
      <link rel="stylesheet" href="<?=base_url()?>theme/user/toy/css/shop.css" type="text/css" />
      <!--//Shoping cart-->
      <!--stylesheets-->
      <link href="<?=base_url()?>theme/user/toy/css/style.css" rel='stylesheet' type='text/css' media="all">
      <!--//stylesheets-->
...
<body>
            ...
            <div class="callbacks_container">
               <ul class="rslides" id="slider4">
                  <li>
                      ...
                      {
                          ?>
                          <div class="slider-img "style=" background-image: url('<?=base_url()?>theme/user/images/<?=$value['image']?>')">
                           <div class="container">
		 ...
		 <!---728x90--->
            ...
            <div class="row banner-below-w3l">
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="<?=base_url()?>theme/user/toy/images/a1.jpg" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Baby Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="<?=base_url()?>theme/user/toy/images/a2.jpg" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Lite-Brite</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="<?=base_url()?>theme/user/toy/images/a3.jpg" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Key Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="<?=base_url()?>theme/user/toy/images/a4.jpg" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Play Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="<?=base_url()?>theme/user/toy/images/a5.jpg" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Gift Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="<?=base_url()?>theme/user/toy/images/a6.jpg" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
               ...
               <ul id="flexiselDemo1">
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="vimages/a1.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="<?=base_url()?>theme/user/toy/images/a2.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="<?=base_url()?>theme/user/toy/images/a3.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid ">
                        <img src="<?=base_url()?>theme/user/toy/images/a4.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="<?=base_url()?>theme/user/toy/images/a5.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid ">
                        <img src="<?=base_url()?>theme/user/toy/images/a6.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                     ...
                     <div class="row">
                           ...
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 <div class="col-md-4 col-sm-4 news-img">
                                    <img src="<?=base_url()?>theme/user/toy/images/t1.jpg" alt="" class="image-fluid">
                                 </div>
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 <div class="col-md-4 col-sm-4 news-img">
                                    <img src="<?=base_url()?>theme/user/toy/images/t2.jpg" alt="" class="image-fluid">
                                 </div>
                                 <div class="col-md-8 col-sm-8 clients-says-w3layouts">
                                    <h4>Sam Deo 
                                    </h4>
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="<?=base_url()?>theme/user/toy/images/tt2.jpg" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span>  velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
                     ...
                     <div class="row">
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="<?=base_url()?>theme/user/toy/images/tt1.jpg" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span>  velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 <div class="col-md-4 col-sm-4 news-img">
                                    <img src="<?=base_url()?>theme/user/toy/images/t3.jpg" alt="" class="image-fluid">
                                 </div>
                                 <div class="col-md-8 col-sm-8 clients-says-w3layouts">
                                    <h4>Sam Deo 
                                    </h4>
      ...
      <!-- //Modal 1-->
      <!--js working-->
      <script src='<?=base_url()?>theme/user/toy/js/jquery-2.2.3.min.js'></script>
      <!--//js working-->
      <!-- cart-js -->
      <script src="<?=base_url()?>theme/user/toy/js/minicart.js"></script>
      <script>
         toys.render();
      ...
      <script src="<?=base_url()?>theme/user/toy/js/responsiveslides.min.js"></script>
      <script>
      ...
      <!--// responsiveslides banner-->	 
      <!--slider flexisel -->
      <script src="<?=base_url()?>theme/user/toy/js/jquery.flexisel.js"></script>
      <script>
      ...
      <script src="<?=base_url()?>theme/user/toy/js/move-top.js"></script>
      <script src="<?=base_url()?>theme/user/toy/js/easing.js"></script>
      <script>
      ...
      <!--bootstrap working-->
      <script src="<?=base_url()?>theme/user/toy/js/bootstrap.min.js"></script>
      <!-- //bootstrap working-->
   </body>
