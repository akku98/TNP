...
<body style="background-image: url(<?=base_url()?>User_assets/logform/images/bg-02.jpg);">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="<?=base_url('AdminLoginCheck')?>">
