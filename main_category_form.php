...
<div id="wrapper">
    ...
    ?>
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Add A New Main Category</strong>
                    </li>
                </ol><br>
                    ...
                    <div class="col-lg-12">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1"> Adding a New Main Category </a></li>
                            </ul>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="fileinput fileinput-new input-group col-sm-8"  data-provides="fileinput">
                                                        ...
                                                        <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new">Select file</span>
                                                            <span class="fileinput-exists">Change</span><input tabindex="3" type="file" required="" name="file_name"></span>
                                                        <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group"><div class="col-sm-3 control-label"></div>
                                                <div class="col-sm-4"><button class="form-control btn btn-success btn-rounded" tabindex="4"><strong>Add Main Category</strong></button> </div>
                                            </div>
        ...
        <?php }
		elseif($item=='yes'){ ?>
			<script>swal("Successfully Added New Category !!!", "Browse To Add New Category !", "success");</script>
		<?php
			}
		}
        ?>
