							...
							<div class="col-md-8">
								...
								<div class="tr-content">
											...
											<div class="entry-header">
                                                <div class="resp-container"  style="height:1900px;">
 
                                                    <iframe class="resp-iframe" src="<?=base_url()?>User_assets/images/others/<?=$value->image?>" gesture="media"  allow="encrypted-media" allowfullscreen></iframe>
