								...
								<div class="tr-content">
                                    	 <div class="tr-post">
											<div class="entry-header">
                                                        <div class="resp-container"  style="height:3100px;">
 
                                                    <iframe class="resp-iframe" src="<?=base_url('ResumeView')?>" gesture="media"  allow="encrypted-media" allowfullscreen></iframe>
