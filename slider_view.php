            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>List Of All Sliders Which is Showing Our Service</h5>
                    ...
                    <thead>
			<tr>
                            <th><center><b>Slider Images</b></center></th>
                    ...
                    ?>
                        <tr class="gradeC" style="padding:20px;">
                            ...
                            <td><center><b><?=$value->dttime?></b></center></td>
                            <td>
                                <b><a href="<?=base_url('Destiny_AdminController/slider_view_delete')?>/<?=$value->slider_id?>/<?=$value->image?>" class="btn btn-danger" >Delete</a></b>
                            </td>
                        </tr>
                    <?php
                            endforeach;
