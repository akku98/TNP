...
<br>
				...
				<form class="validate-form" method="post" action="<?=base_url('StdDataUpdSubmit')?>">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>10th %</span>
                            <br><input class="input100" type="number" value="<?=$value->X_per?>"  name="X_per" placeholder="Enter Your 10th %">
						<span class="focus-input100"></span>
					</div>
                                    
                     <div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>12th %</span>
                           <br><input class="input100" type="number" name="XII_per" value="<?=$value->XII_per?>"  placeholder="Enter Your 12th %">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>1st Semester %</span>
                            <br><input class="input100" type="number" name="I_sem_per" value="<?=$value->I_sem_per?>" placeholder="Enter Your Ist Semester %">
						<span class="focus-input100"></span>
					</div>
                                    
                     <div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>2nd Semester %</span>
                           <br><input class="input100" type="number" name="II_sem_per" value="<?=$value->II_sem_per?>" placeholder="Enter Your IInd Semester %">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>3rd Semester %</span>
                            <br><input class="input100" type="number" name="III_sem_per" value="<?=$value->III_sem_per?>" placeholder="Enter Your IIIrd Semester %">
						<span class="focus-input100"></span>
					</div>
                                    
                     <div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>4th Semester %</span>
                           <br><input class="input100" type="number" name="IV_sem_per" value="<?=$value->IV_sem_per?>" placeholder="Enter Your IVth Semester %">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "5th Semester % is required"><br>
						<span>5th Semester %</span>
                            <br><input class="input100" type="number"  name="V_sem_per" value="<?=$value->V_sem_per?>" placeholder="Enter Your Vth Semester %">
						<span class="focus-input100"></span>
					</div>
                                    
                     <div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>6th Semester %</span>
                           <br><input class="input100" type="number"  name="VI_sem_per" value="<?=$value->VI_sem_per?>" placeholder="Enter Your VIth Semester %">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100  m-b-18"><br>
						<span>7th Semester %</span>
                            <br><input class="input100" type="number"  name="VII_sem_per" value="<?=$value->VII_sem_per?>" placeholder="Enter Your VIIth Semester %">
						<span class="focus-input100"></span>
					</div>
                                    
                     <div class="wrap-input100  m-b-18"><br>
						<span>8th Semester %</span>
                           <br><input class="input100" type="number"  name="VIII_sem_per" value="<?=$value->VIII_sem_per?>" placeholder="Enter Your VIIIth Semester %">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "This Field is required"><br>
						<span>Overall %</span>
                            <br><input class="input100" type="number" name="overall_per" value="<?=$value->overall_per?>" placeholder="Enter Overall %">
						<span class="focus-input100"></span>
					</div>
