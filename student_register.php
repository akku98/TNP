						...
						<div class="row">
							<div class="col-md-8">
								...
								<div class="tr-content">
                                    <div class="resp-container"  style="height:2500px;">
 
                                        <iframe class="resp-iframe" style="border-radius:10px;" src="<?=base_url('StudentRegisterView')?>" gesture="media"  allow="encrypted-media" allowfullscreen></iframe>
